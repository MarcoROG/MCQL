...
from pypong.MCQPlayer import MCQPlayer
...
def run():
    configuration = {
        ...
        'paddle_velocity': 6.,
        'paddle_bounds': (10, 438), # This sets the upper and lower paddle boundary.The original game didn't allow the paddle to touch the edge, 
        'line_image': 'assets/dividing-line.png',
        'ball_image': 'assets/ball.png',
        'ball_velocity': 3.,
        'ball_velocity_bounce_multiplier': 1.10,

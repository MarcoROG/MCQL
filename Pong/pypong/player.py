...
class BasicAIPlayer(object):
    ...
    def update(self, paddle, game):
        ...
        if (paddle.rect.x < game.bounds.centerx and game.ball.rect.x < game.bounds.centerx-20) or (paddle.rect.x > game.bounds.centerx and game.ball.rect.x > game.bounds.centerx+20):
